...
Your room is upstairs, but the evening doesn't feel finished, and your shoes are already ruined. A drink, then. The lounge is off the back of the lobby, past the elevators, and a wingback chair beats standing here dripping on the marble.
...
> `CHECK agent/academic (target 7) -> FAIL`
...
> _choice: **“You use the mirror.”**  (other: “You stay with cover and glimpses.”)_
...
> `CHECK composure/agent (target 8) -> FAIL`
...
> _choice: **“You try to slip away.”**  (other: “You decide to stop it.”)_
...
> _choice: **“You take the fire extinguisher.”**  (other: “You take a lobby chair.”, “You use the luggage cart.”, “You take the brass stanchion.”)_
...
> **[FILE EXTRACT: pale_field_report_03_OTT_0818]**
...
> **[FILE EXTRACT: pale_recommendation_r_flett]**

---
_influence 2 · skills{confrontation 1} · incident 'the Woman with the Pale Eyes'_