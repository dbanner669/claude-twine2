...
**Implementation status:** three of four incidents are implemented, style-audited, and pending first-play review — `the Toronto Blackout` (`blackout.twee`, BLK-085–BLK-215, audit 2026-05-29), `the Dark of Manitoulin` (`manitoulin.twee`, MAN-085–MAN-205, audit 2026-06-01), and `the Woman with the Pale Eyes` (`pale.twee`, PALE-085–PALE-205, audit 2026-06-12). All four are wired in CC-400; `Wet Dog Smell` (`wds.twee`) is scaffolded with drafting placeholders outstanding.
