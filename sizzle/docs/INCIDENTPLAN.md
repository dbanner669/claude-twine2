...
**Implementation status:** all four incidents are implemented, style-audited, and pending first-play review — `the Toronto Blackout` (`blackout.twee`, BLK-085–BLK-215, audit 2026-05-29), `the Dark of Manitoulin` (`manitoulin.twee`, MAN-085–MAN-205, audit 2026-06-01), `the Woman with the Pale Eyes` (`pale.twee`, PALE-085–PALE-205, audit 2026-06-12), and `Wet Dog Smell` (`wds.twee`, WDS-085–WDS-205, audit 2026-06-13). All four are wired in CC-400.
